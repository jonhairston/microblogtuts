...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Post.current'
        db.delete_column(u'microblogs_post', 'current')

        # Adding field 'Post.content'
        db.add_column(u'microblogs_post', 'content',
                      self.gf('django.db.models.fields.TextField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Post.current'
        db.add_column(u'microblogs_post', 'current',
                      self.gf('django.db.models.fields.TextField')(default=1),
                      keep_default=False)

        # Deleting field 'Post.content'
        db.delete_column(u'microblogs_post', 'content')
